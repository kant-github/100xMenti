...
export default function LiveSessionCodeTicker({ sessionCode }: LiveSessionCodeTickerProps) {
    ...
    return (
        <div className="absolute right-1/2 translate-x-1/2 top-4 bg-neutral-200 px-5 py-2.5 rounded-lg border-[1px] border-neutral-300 backdrop-blur-md shadow-md flex items-center justify-center gap-x-2 transition-all">
            <span className="text-neutral-950 font-bold text-sm">Use this code to join </span>
