...
export default function LaunchQuizModal({ setOpenLaunchQuizModal, launchQuizHandler, quiz, loading }: LaunchQuizModalProps) {
    return (
            ...
            <UtilityCard className="relative z-[100] bg-white dark:bg-neutral-900 p-8 rounded-2xl shadow-2xl w-full max-w-md flex flex-col items-center space-y-6">
                ...
                <div className="gap-3 w-full grid grid-cols-2">
                    <Button
                        ...
                        className="flex-1 flex items-center justify-center gap-3 px-6 py-5 text-sm font-medium bg-neutral-900 hover:bg-neutral-700 text-white rounded-xl"
                    >
                        {
                            loading ? (
